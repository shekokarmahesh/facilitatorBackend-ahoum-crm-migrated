...
# Simple CORS configuration without session support
CORS(app, 
     origins=["https://preview--ahoum-crm.lovable.app", "http://localhost:8080", "http://127.0.0.1:8080", "http://192.168.1.66:8080", "http://localhost:3000", "http://localhost:3031", "http://localhost:5173", "http://127.0.0.1:5173"],
